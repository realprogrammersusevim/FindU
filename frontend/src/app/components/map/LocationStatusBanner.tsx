    ...
    >
        ...
        <>
          ...
          <span>
            ...
            <span className="font-normal">
              ...
              and set to <em>While Using</em>. Then reload this page. If already
              enabled there, tap the <strong>AA</strong> icon in Safari&apos;s
      ...
      {locationStatus === "insecure" && (
        <>
          ...
          <span>
            ...
            <span className="font-normal">
              Open this page over <strong>HTTPS</strong> or use{" "}
              <strong>localhost</strong> instead of an IP address.
            </span>
          </span>
        </>
      )}
      {locationStatus === "unavailable" && (
        <>
          ...
          Location unavailable — your device may not support GPS or the request
          timed out.
        </>
      )}
    </div>
